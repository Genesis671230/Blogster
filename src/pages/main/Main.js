  ...
  return (
    <div className='main'>
      ...
      <div className="textMainDiv">
        <p>Fine the best <span className="spanMainText">services </span>for your business.</p> 
        </div>

          <div className="frontPageInputEmail"><input type="email" placeholder='Lets join now'/> </div>
            <div className="frontPageJoinButton"><button type="button">Join</button> </div>
          </div>
